...
A web-based board game that teaches project management concepts through interactive gameplay. Players navigate through realistic project phases from initial scope to construction completion, managing resources, making strategic decisions, and adapting to real-world challenges.

## Current Status: Version 2.4

Fully functional, production-ready game with advanced features and professional user experience.
...
**No build required** - Static web application with browser-based React compilation.

**IMPORTANT**: Game MUST be served via HTTP server. Opening `index.html` directly in browser will fail due to CORS restrictions preventing JavaScript module loading.
...
- Card Sub-Systems: CardDetailView, WorkCardDialogs, CardActions, CardAnimations
...
- Interactive Feedback System: Toast notifications, tooltips, context-sensitive help
- Professional UI Polish: 11-file CSS system with design tokens
...
├── PlayerMovementVisualizer.js # Movement animations
